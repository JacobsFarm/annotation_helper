...
export default {
  ...
  annotate_delete_image: 'Move image to trash',
  annotate_delete_confirm: 'Move this image and its label to the project trash?',
  ...
  annotate_no_images_hint: 'Copy image files into the images folder, then refresh.',
