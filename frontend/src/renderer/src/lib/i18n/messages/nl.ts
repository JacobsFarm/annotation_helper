...
const nl: Record<keyof typeof en, string> = {
  ...
  annotate_no_images_hint: 'Zet afbeeldingen in de map input en vernieuw daarna.',
  annotate_open_input: 'Map input openen',
  ...
  dataset_undo_file: 'Bestandswijziging ongedaan maken',
  dataset_undo_file_hint: 'Draai de laatste verplaatsing of verwijdering terug. Blijft na herstarten bestaan, anders dan de vorm-undo.',
  dataset_undo_done: 'Bestandswijziging ongedaan gemaakt',
  dataset_undo_empty: 'Er valt niets meer ongedaan te maken.',
  ...
  settings_task: 'Taak',
  settings_recycle: 'Prullenbak',
  settings_recycle_hint:
    'Originelen van geannoteerde afbeeldingen en alles wat je weggooit komen hier terecht. Er verlaat niets het project tot je de prullenbak leegt.',
  settings_recycle_count: '{files} bestanden, {size}',
  settings_recycle_empty: 'De prullenbak is leeg.',
  settings_recycle_empty_action: 'Definitief legen',
  settings_recycle_emptying: 'Bezig met legen…',
  settings_recycle_confirm:
    '{files} bestanden definitief uit de prullenbak van dit project verwijderen? Dit kan niet ongedaan worden gemaakt.',
  settings_recycle_emptied: '{files} bestanden definitief verwijderd',
